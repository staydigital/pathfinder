...
const { selectIds, selectEntities } = cellStateEntityAdapter.getSelectors()
...
const getCellIdsForFeature = createSelector(cellStateFeatureSelector, selectIds)

export const getAllEntities = getCellStateForFeature

export const getAllIds = getCellIdsForFeature
